...
class ScorePage extends StatefulWidget {
  final int id;
  final int patientId;
  const ScorePage({Key? key, required this.id, required this.patientId})
      : super(key: key);
                        ...
                        Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Text(
                                "B-B Score : ${snapshot.data!.first.bbScore} %",
                                style: const TextStyle(fontSize: 20),
                              ),
                              Text(
                                  "Elevation Angle Injured : ${snapshot.data!.first.elevationAngleInjured}°",
                                  style: const TextStyle(fontSize: 20)),
                              Text(
                                  "Elevation Angle Healthy : ${snapshot.data!.first.elevationAngleHealthy}°",
                                  style: const TextStyle(fontSize: 20)),
                              const SizedBox(
                                height: 30,
                              ),
          ...
          onPressed: () {
            final newScore = widget.patientId == 0
                ? Score(
                    ...
                    elevationAngleInjured: score.elevationAngleInjured,
                    elevationAngleHealthy: score.elevationAngleHealthy,
                    bbScore: score.bbScore,
