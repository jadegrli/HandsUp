...
class AllScoresOfPatientPage extends StatefulWidget {
  final int patientID;
  const AllScoresOfPatientPage({Key? key, required this.patientID})
      : super(key: key);
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data != null && snapshot.data!.isNotEmpty) {
            return ListView.builder(
              primary:
                  true, //if true doesn't scroll because of SingleChildScrollView
            ...
            return const Align(
                child: Text("No data"), alignment: FractionalOffset.center);
          }
        });
  }
}
